  ...
  return withXcodeProject(config, async (config) => {
    ...
    try {
      ...
      if (e.message.includes("reading 'path'")) {
        console.error(e);
        throw new Error(
          `[expo-share-intent-next] Could not add resource files to the Share Extension, please check your "patch-package" installation for xcode (see: https://github.com/eatmatch/expo-share-intent-next?tab=readme-ov-file#installation)`,
        );
      }
      throw e;
    }
